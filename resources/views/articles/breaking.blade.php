...
@section('title', 'Breaking News Segment - S4MCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Breaking News Article</small></h1>
        </div>
    ...
    <ul class="xbreadcrumbs">
        <li>
            <a href="/dashboard">
                ...
                <li class="current">
            <a href="javascript:;">Breaking News Article</a>
        </li>
    </ul>
</div>           <header>
               <i class="icon-big-notepad"></i>
               <h2><small>Breaking News Article</small></h2>
