    ...
    <div class="container-fluid">
      ...
      <!--Text Area - No Resize begin-->
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <textarea  name="social_title" id="soctitle" rows="2" class="no-resize  title_range valid">{{$article->social_title}}</textarea>
                    <span for="title" generated="true" class="error" style="display: none;">Please enter a valid text.</span>
                </div>
            </div>
        </div>
        ...
        <div id="Text_Area_Resizable" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <textarea  name="social_summary" rows="2" class="" id="social_summary">{{$article->social_summary}}</textarea>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="form-legend" id="meta-detail">Meta Detail</div>
       <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" class="reqired" value="{{$article->url}}" name="url">
      ...
      <!--Text Area - No Resize begin-->
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <textarea  name="meta_title" id="metatitle" rows="2" class="no-resize  title_range valid">{{$article->meta_title}}</textarea>
                </div>
            </div>
        </div>
        <!--Text Area - No Resize end-->
        ...
        <div id="Text_Area_Resizable" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <textarea  name="meta_desc" rows="2" class="" id="meta_desc">{{$article->meta_desc}}</textarea>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $('#artititle ').on('focusout',function(){
     var artititle= $(this).val();
    $('#soctitle').val(artititle);
    $('#metatitle').val(artititle);
});
</script>

<script type="text/javascript">
    $('#summary ').on('focusout',function(){
     var summary= $(this).val();
    $('#social_summary').val(summary);
    $('#meta_desc').val(summary);
});
</script>
@stop
