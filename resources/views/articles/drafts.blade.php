...
@section('title', 'My Drafts - S4MCMS')
                        ...
                        <tbody>
                            ...
                            <tr class="gradeA" id="rowCur{{$article->article_id}}" >
                                <td>
                                    ...
                                    <!-- <a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Assigned to -Sharabani Mukherjee, Assigned by -Hiten Mehta"  style="display:block;">
