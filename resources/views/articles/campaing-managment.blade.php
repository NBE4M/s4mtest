...
@section('title', 'Add-edit-sub Master category - E4MCMS')
...
<div class="main-content">
    ...
    <form class="form-horizontal" id="validation_form" enctype= "multipart/form-data" method="POST" action="{{url('')}}/campaing/add" onsubmit="return validatecampaingData()">
        {!! csrf_field() !!}
