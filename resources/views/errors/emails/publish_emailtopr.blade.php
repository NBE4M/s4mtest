        ...
        <tr>
          <td style="padding:10px;" bgcolor="#d7fbea">
              <p style="font-weight:bold; text-align:center; color:#45715c; font-size:16px; margin-bottom:5px;">Dear {{$name}},</p>
                <p style="font-size:14px; line-height:18px; font-weight:bold; text-align:center; color:#404040;"><span style="font-size:22px;">I</span>t is a great pleasure for us to share the details of the story featuring you from our exchange4media newsletter.</p>
            </td>
        </tr>
