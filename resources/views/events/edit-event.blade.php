...
@section('title', 'edit-events - E4MCMS')
...
<div class="main-content">
   ...
   @foreach($posts as $a)
    <form class="form-horizontal" action="{{ url('/event/update') }}" method="POST"enctype= "multipart/form-data"  onsubmit="return validateEventData()">
       {!! csrf_field() !!}
