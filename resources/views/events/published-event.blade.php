                    ...
                    <table class="table table-striped" id="tableSortable">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX" id="rowCur{{$a->event_id}}">
                                <td><a href="{{url('')}}/event/edit/?id={{$a->event_id}}">{{$a->event_id}}</a> <a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Submitted by: Harish Dido Harish DidoDido. Submitted on: 11-03-2013."><i class="icon-photon info-circle"></i></a></td>
                                <td><a href="{{url('')}}/event/edit/?id={{$a->event_id}}">{{$a->title}}</a>
                                </td>
                                <td><a href="{{url('')}}/event/edit/?id={{$a->event_id}}">{{$a->category}}</a></td>
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{url('')}}/event/edit/?id={{$a->event_id}}">Event</a></li>
