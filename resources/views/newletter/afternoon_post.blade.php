...
<title>Exchange4Media Afternoon Post</title>
<style type="text/css">
  ...
  <tr>
    ...
    <!--=======container table start=========-->
      <table width="600" cellpadding="0" class="full" cellspacing="0" border="0" align="center" style="width:600px;">
        <!--row start-->
        <tr>
          <td colspan="2"><img src="https://www.exchange4media.com/images/newsletter/afternoonpostbanner.png" width="600" alt="Logo" border="0" style="max-width: 100%; display:block; "></td>
        </tr>
        <!--row end--> 
      ...
      <!--   <tr>
       ...
       <!--  <tr>
        ...
        <!--row start-->
        @foreach($ArrViewArticle->take(10) as $key =>  $ArrlistingArticle)
        <tr>
...
<td width="5"></td>
        ...
        <!-- blank row start
         <tr>
          <td height="15px" colspan="2"><a href="https://e4mevents.com/conclave-south-2018/"><img src="https://cms.exchange4media.com/img/sc.jpg"/></a></td>
        </tr> 
        <!--blank row end-->
         ...
         <!--  <td bgcolor="#ffffff" colspan="2" style="padding:10px;"><p style="padding:10px; border:1px solid #cccccc; color:#5a5a5a; line-height:22px; margin:0;"> If you're having trouble viewing this email, please <a href="http://cms.exchange4media.com/newsletterhtml/NewsLetter14032018.html" style="color:#0066b4;">click 
          ...
          <tr>
            <td bgcolor="#ffffff" colspan="2" style="padding:10px;"><p style="padding:10px; border:1px solid #cccccc; color:#5a5a5a; line-height:22px; margin:0;"> If you're having trouble viewing this email, please <a href="{{Config::get('constants.SiteCmsurl')}}newsletter/afternoon-post-<?php echo date('d-m-Y')?>.html" style="color:#0066b4;">click 
              here</a></p></td>
            </tr>
        <tr> 
          <!-- SOCIAL -->
