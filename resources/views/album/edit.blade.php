...
@section('title', 'Edit Album - S4MCMS')
...
<div class="main-content">
        ...
        <ul class="xbreadcrumbs">
            ...
            <li>
                ...
                <ul class="breadcrumb-sub-nav">
                    <li>
                        <a href="{{url('cms/album/create')}}">Create New Album</a>
                    </li>
                    <li>
    ...
    {!! Form::open(array('url'=>'album/updates','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {{ csrf_field() }}
                ...
                <table class="table table-striped table-responsive" id="tableSortableResMed">
                    ...
                    <tbody>
                        ...
                        <tr id="row_{{$photo->photo_id}}">
                            <td width="20%">
                                <img src="{{ config('constants.storagepath').config('constants.awalbumimagedir').$photo->photopath}}" alt="user" style="width:40%;" />
                            </td>
...
<!--                                    <td class="center">{{ $photo->source }}</td>
    ...
    <div class="container-fluid">
    <div class="form-legend" id="al-feature">Tags Detail
        </div> 
