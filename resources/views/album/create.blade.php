...
@section('title', 'Create New Album - S4MCMS')
...
<div class="main-content">
        ...
        <ul class="xbreadcrumbs">
            ...
            <li>
                ...
                <ul class="breadcrumb-sub-nav">
                    <li>
                        <a href="<?php echo url('cms/album/create') ?>">Create New Album</a>
                    </li>
                    <li>
    ...
    {!! Form::open(array('url'=>'cms/album/','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}    
...
//                                         //$("#Taglist").tokenInput("add", {id: 9992, name: "test22"});
                    ...
                    $("#Taglist").tokenInput("https://cms.samachar4media.com/tags/get/Json", {
                        theme: "facebook",
                        searchDelay: 300,
                        minChars: 4,
