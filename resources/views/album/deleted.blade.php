...
@section('title', 'Deleted Album - S4MCMS')
    ...
    <div class="panel-content filler">
        ...
        <div class="panel-search container-fluid" style="height: 100px">
            <form class="form-horizontal" method="get" action="">
                ...
                <input id="panelSearch" value="{{ isset($_GET['keyword']) ? $_GET['keyword']:'' }}" required placeholder="Search" type="text" name="keyword">
...
<div class="main-content">
    ...
    {!! Form::open(array('url'=>'cms/album/','class'=> 'form-horizontal','id'=>'validation_form')) !!}
    {!! csrf_field() !!}
