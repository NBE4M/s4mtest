...
@section('title', 'Published Album - S4MCMS')
    ...
    <div class="panel-content filler">
        ...
        <div class="panel-search container-fluid" style="height: 100px">
            <form class="form-horizontal" action="">
                ...
                <input id="panelSearch" required placeholder="Search" type="text" value="{{ isset($_GET['keyword']) ? $_GET['keyword']:'' }}" name="keyword">
                    ...
                    <table class="table table-striped table-responsive" id="tableSortableResMed">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX" id="rowCur{{$qb->id}}">
                                ...
                                <td style="width:160px;"><img src="{{config('constants.storagepath').config('constants.awalbumimagedir').$qb->photopath}}" alt="Album Image" style="width:70%;" /></td>
                                <td><a href="{{url('cms/album')}}/{{$qb->id}}">{{$qb->title}}</a></td>
                                <td>{{$qb->updated_at}}</td>
