        ...
        <div class="widget-area widget-latest-users widget-front">
          ...
          <div class='widget-tip-template'>
                <div class='avatar-section'>
                    <img class='avatar-big' src='{{url("images/photon/user2.jpg")}}' alt='profile' />
                </div>
            ...
            <ul>
                ...
                <li  >
                    <div class="avatar-image"  >
                       @if($writers->photo)
                        <img src="{{url('images').'/'.$writers->photo}}" alt="profile"/>
                        @else
                         <img src="{{url('images/photon/author_dummy.png')}}" alt="profile"/>
                        @endif
                    </div>
