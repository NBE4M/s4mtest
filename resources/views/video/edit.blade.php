...
@section('title', 'Edit Video - E4MCMS')
    ...
    <div class="container-fluid">
        ...
        <div id="tab-example1" class="tab-pane fade active in">
            ...
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <input name="video_source" id="video_source" value="{{$video->video_soruce}}" type="text">
                    </div>
                </div>
            </div>
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <input name="advertiser" id="advertiser" value="{{$video->advertiser}}" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <input name="industry" id="industry" value="{{$video->industry}}" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <input name="agency" id="agency" value="{{$video->agency}}" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <textarea  rows="4" class="" name="embed_code" id="embed_code">{{$video->video_code}}</textarea>
                    </div>
                </div>
            </div>
