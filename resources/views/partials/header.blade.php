        ...
        <a class="nav-link dropdown-toggle"  id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         {{Str::upper($menu->title)}}
          ...
          <div class="dropdown-menu custom-drop-down" aria-labelledby="navbarDropdownMenuLink">
            ...
            @if($submenu->slug == 'photos' || $submenu->slug == 'videos' || $submenu->slug == 'author' || $submenu->slug == 'latest/articles' ) 
           ...
           @else
           <a class="dropdown-item" @if(strpos($submenu->slug,'https') !== false) target="_blank"@else{{url('/')}}/{{$submenu->slug.'-news.html'}}@endif  href="@if(strpos($submenu->slug,'https') !== false){{$submenu->slug}} @else{{url('/')}}/{{$submenu->slug.'-news.html'}}@endif">{{Str::upper($submenu->title)}}</a>
           @endif
            @endforeach
        </div>
        </li>
