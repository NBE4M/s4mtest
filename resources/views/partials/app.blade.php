<!DOCTYPE html>
  <html lang="en">
    <head>
      ...
      <link rel="alternate" href="https://www.samachar4media.com/" hreflang="hi-in" />        
      <!-- CSRF Token Start-->
      ...
      <!-- <link rel="stylesheet" href="{{Config::get('constants.storagepath').'css/bootstrap-4.0.0.css'}}"> -->
      <link rel="stylesheet" href="{{Config::get('constants.storagepath').'css/mdb.min.css'}}">
     
      <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css" integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/" crossorigin="anonymous">
      <!-- <link rel="stylesheet" href="{{Config::get('constants.storagepath').'css/custom.css'}}"> -->
      <link rel="stylesheet" href="{{Config::get('constants.storagepath').'css/custom.css'}}">
      <link rel="stylesheet" href="{{Config::get('constants.storagepath').'css/menu.css'}}">
      <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
   ...
   <!-- <script src="{{url('FeedifySW.js')}}"></script> -->
    ...
    <link rel="manifest" href="{{url('manifest.json')}}"> 
      ...
      {"@context": "https://schema.org","@type": "Organization","name": "Samachar4media",   "url": "{{url('')}}","logo": "https://www.samachar4media.com/images/logo.png",  "sameAs": [     "https://www.facebook.com/Samachar4media/","https://twitter.com/samachar4media"]}
    </script>
    <script type="application/ld+json">
