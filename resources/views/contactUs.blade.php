			...
			<div class="theiaStickySidebar">
				...
				<nav aria-label="breadcrumb">
					<small> <ol class="breadcrumb bg-white text-warning p-0">
						...
						<li class="breadcrumb-item"><a href="{{url('news/contact.html')}}">संपर्क करें</a></li>
							...
							<div class="row m-0">
								<div class="col p-0">
									...
									<div class="row">
										...
										<div class="col-md-4 col-lg-4 col-sm-4 col-12 mt-4 text-center dashed-bdr-r"><figure><img src="{{Config::get('constants.storagepath')}}images/team.jpg" class="img-fluid rounded-circle" style="width: 80%;">
										</figure>
								...
								<div class="col-md-4 col-lg-4 col-sm-4 col-12 mt-4 text-center"><figure><img src="{{Config::get('constants.storagepath')}}images/team.jpg" class="img-fluid rounded-circle" style="width: 80%;">
								</figure>
