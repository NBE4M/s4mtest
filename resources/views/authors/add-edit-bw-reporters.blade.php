...
@section('title', 'Add-edit-reporter - S4MCMS')
...
<div class="main-content">
    ...
    <form class="form-horizontal" onsubmit="return validateAuthorData()" method="POST" enctype= "multipart/form-data" action="{{ url('/article/addAuthor') }}">
       ...
       <input id="photo" class="uniformRadio" type="hidden" value="" name="photoset" style="opacity: 0;">
        ...
        <div class="container-fluid">
            <div class="form-legend" id="new">Add A New S4M Reporters
            ...
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="controls">
                        <input  name="email" type="email" id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required="">
                    </div>
                </div>
            </div>
            <div class="control-group row-fluid">
                ...
                <div class="span9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="input-append">
                            <div class="uneditable-input span3"><i class="icon-file fileupload-exists"></i> <span class="fileupload-preview"></span></div><span class="btn btn-file"><span class="fileupload-new">Select file</span><span class="fileupload-exists">Change</span><input  name="photo"type="file"  id="profilePic"></span><a href="javascript:;" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX" id="rowCur{{$a->author_id}}">
                                <td style="width:160px;">
                                    <img src="{{ config('constants.storagepath').config('constants.awalbumimagedir').$a->photo}}" alt="User Image" style="width:50%;" onerror="this.onerror=null;this.src='{{asset("images/s4m-staff.png")}}';"></td>
