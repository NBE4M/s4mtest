    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        if (Cache::has('customSection')) {
            ...
            $customSection = DB::table('custom_section')->select('title','url','photopath','phototitle','category_ename','category_hname','sequence')->where('sequence','!=', 0)->orderby('sequence','asc')->limit(5)->get();
