...
class CreateventController extends Controller
{
    ...
    {  
        ...
        return view('events.add-new-events');
    }
    ...
    public function store(Request $request)
        {
        $source = public_path().'/jsonfile';
        $destination =public_path().'/appnew';
        Storage::copy($source,$destination);
        Session::flash('message', 'Your data has been successfully add.');
        return Redirect::to('event/published?channel');
    }
